...
func (m *mockBashPermissionService) IsAutoApproved(sessionID string) bool { return false }
...
func (m *recordingPermissionService) IsAutoApproved(sessionID string) bool { return false }
